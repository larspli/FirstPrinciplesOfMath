...
\spr{
Common ways of saying $ 2^3 $ are\footnote{Attention! The examples illustrate a paradox in the English language. Thing is, \textit{power} is also a (and in the spoken language the preferred) synonym for \textit{exponent}.}
\begin{itemize}
