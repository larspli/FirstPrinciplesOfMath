...
\spr{
	...
	\begin{itemize}
		...
		\item ''2 opphøyd i 3''
	\end{itemize}
I programmeringsspråk brukes gjerne symbolet \sym{\^{}} eller symbola \sym{**} mellom grunntall og eksponent.
}
\newpage
\info{Merk}{
...
\fork{\ref{pota0} \potanull}{
	Et tall delt på seg sjølv er alltid lik 1, derfor er 
	\[
	\frac{a^{n}}{a^{n}}=1
	\]
