...
\[ 2+3=5 \]
\fig{plusm1}
The order in which we add have no impact on the result; starting off with 2 and adding 3 is the same as starting off with 3 and adding 2:
\[ 3+2=5 \]
\fig{plusm1a}
\spr{
...
The order of the terms have no impact on the sum.
}
...
\sym{+} brings the possibility of expressing numbers in different ways, for example is $ {5=2+3} $ and $ {5=1+4} $. In this context \sym{=} means ''have the same value as''. This is also the case regarding subtraction, multiplication and divison, which we'll look at in the next three sections.
}
