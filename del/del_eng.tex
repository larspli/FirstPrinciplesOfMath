...
\sym{:} is the symbol for divison.
Division has three different interpretations, here exemplified by the calculation $ 12:3 $:\regv
...
Common ways of saying $ 12:3 $ are
\begin{itemize}
	\item ''12 divided by 3''
	\item ''12 to 3''
\end{itemize}
In a lot of languages and contexts \sym{$ / $} is used instead of \sym{$:$}, especially in computer programming. \vsk
