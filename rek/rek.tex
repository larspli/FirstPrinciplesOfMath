...
\fork{Eksempel 1}{
\fig{delalg}
Figuren over illustrerer mengda 76, som vi skal dele inn i 4 like store grupper. 
\begin{itemize}
	\item Vi startar med å fordele så mange av tiarane som mogleg. Av dei 7 tiarane, kan kvar gruppe få 1. Da har vi totalt tatt vekk 4 tiarar.
	\fig{delalga}
\end{itemize}
}
\newpage
