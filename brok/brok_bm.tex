...
\info{Forkorting via primtalsfaktorisering}{
	Det er ikke alltid like lett å legge merke til en felles faktor, slik vi har gjort i \textsl{Eksempel 2} og \textsl{Eksempel 3} over. Vil man vere helt sikker på at man ikke har oversett felles faktorer, kan man alltid primtalsfaktorisere (se side \pageref{primtalsfakt}) både teller og nevner. For eksempel har vi at
	\alg{
