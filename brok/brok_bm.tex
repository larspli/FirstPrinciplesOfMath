...
Vi kan ikke se på en tallinje hver gang vi skal dele med brøker, så nå skal vi komme frem til en generell regnemetode ved igjen å bruke $ 4:\frac{2}{3} $ som eksempel. For denne metoden bruker vi denne betydningen av divisjon:
\begin{center}
