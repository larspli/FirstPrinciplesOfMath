...
\reg[Blanda tal\index{tal!blanda}]{
	Om vi adderer et heltal med en brøk der telleren er mindre enn nevneren, får vi et \textit{blanda tall}.
}
\eks[1]{
...
\info{Obs!}{
	I mange bøker vil du finne tall som dem fra \textsl{Eksempel 1} over skrevet slik
	\[   2\dfrac{5}{7} \qquad\qquad
	8\dfrac{2}{7} \qquad\qquad
	4\dfrac{1}{10}  \]
}
...
\eks[2]{
	...
	\sv 
	Vi legger merke til at telleren er 17 og nevneren er 3. Det største heltalet vi kan gange med 3 utan at produktet blir større enn 17, er 5. Altså kan vi skrive
	\alg{
...
\eks[3]{
	Skriv om $ 3+\frac{4}{5} $ til en brøk.
