...
Lat oss sjå for på brøken $ \frac{1}{4} $ som ei mengde. Vi startar da med å tenke på talet 1 som ei rute\footnote{Av praktiske årsakar velg vi oss her ei einarrute som er større enn den vi brukte i \hrs{Talavare}{Kapittel}.}: 
\begin{figure}[hbt]
	\centering
...
\begin{itemize}
	...
	\item Tellaren i $ \frac{3}{5} $ fortel at der er 3 femdelar. Når desse 3 delane blir delt i to, blir dei totalt til $ 3\cdot2=6 $ tidelar. Altså har $ \frac{3}{5} $ same verdi som $ \frac{6}{10} $.
\end{itemize}
...
\sv
Da $ 30:6=5 $, deler vi både tellar og nemnar med 5:
\alg{
...
Lat oss sjå på reknestykket\footnote{Vi minner om at raudfarga på pila indikerer at ein skal vandre fra pilspissen til andre enden.}
\[ \frac{3}{5}-\frac{1}{2} \]
\fig{br7}
\fig{br7t}
...
\fig{br7a}
\fig{br7ta}
Det vi har gjort, er å utvide begge brøkane slik at dei har same nemnar, nemleg 10. Når nemnarene i brøkane er like, kan vi rekne ut subtraksjonsstykket mellom tellarane:
\alg{
...
Viss vi gongar saman alle nemnarane i et reknestykke, finn vi alltid ein fellesnemnar, men vi sparer oss for store tal om vi finn den \textsl{minste} fellesnemnaren. Ta for eksempel reknestykket
\[ \frac{7}{6}+\frac{5}{3} \]
Her kan vi bruke fellesnemnaren $ {6\cdot3=18} $, men det er betre å merke seg at $ 6\cdot1=3\cdot2=6 $ også er ein fellesnemnar.
}
\newpage
\eks[2]{
	Rekn ut
...
\fig{br15}
\fig{br15t}
Vi har her 4 åttedelar som vi skal fordele likt på 2. Dette blir $ 4:2=2 $ åttedelar.
\fig{br15a}
\fig{br15ta}
Altså er
\[ \frac{4}{8}:2=\frac{2}{8} \]
...
Vi har sett\footnote{Sjå tekstboksen med tittelen \textit{Ei tolking av gonging med brøk} på s. \pageref{brtolk}.} korleis å gonge med ein brøk inneber å gonge det andre talet med tellaren, og så dele produktet med nemnaren. Lat oss bruke dette til å rekne ut
...
Lat oss forenkle brøkuttrykket
...
\info{Brøkar forenklar utrekningar}{
	...
	\[ 0,125\cdot16 \]
	vil for de fleste av oss ta ei stund å løyse for hand med vanlige mulitplikasjonsregler. Men bruker vi brøkuttrykket får vi at
	\alg{
