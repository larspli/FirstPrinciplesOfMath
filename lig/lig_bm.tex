...
\[ x^2=9 \]
Dette kalles en \textit{potenslikning}\index{potenslikning}. Potenlikninger er vanligvis vanskelige å løse bare ved hjelp av de fire regneartane, så her må vi også nytte oss av potensregler. Vi opphøyer begge sidene av likningen med den omvendte brøken\footnote{Husk at $ 2=\frac{2}{1} $.} til 2:
...
\info{Merk}{
	Selv om likningen
	\[ x^a=b \]
	har $ a $ løsningar, er ikke alle nødvendigvis \textit{reelle}\footnote{Som vi tidligere har vært inne på, er \textit{reelle} og \textit{imaginære} tall noe vi ikke går nærmere inn på i denne boka}. I denne boka nøyer vi oss med å finne alle rasjonale eller irrasjonale tall som løser likningen. For eksempel har likning,
	\[ x^3=8 \]
