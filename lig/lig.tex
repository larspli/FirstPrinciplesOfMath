...
\begin{itemize}
	...
	\item For tal med same forteikn, er det talet med størst verdi som er størst.
...
\[ 9>8 \]
Om vi gongar begge sider av ulikskapen med $ -1 $, får vi $ -9 $ på venstre side og $ -8 $ på høgre side. Men $ -9 < -8$. Symbolet fra vår opprinnelege ulikskap har altså endra seg frå \sym{>} til \sym{<}
\reg[Løysing av ulikskapar]{
Når ein gongar eller deler begge sider av ein ulikskap med eit negativt tal, vil $ \sym{>} $ endre seg til $ \sym{<} $, og omvend.
}
\end{document}
