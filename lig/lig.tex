...
\[ x^2=9 \]
Dette kallast ei \textit{potenslikning}\index{potenslikning}. Potenlikningar er vanlegvis vanskelege å løyse berre ved hjelp av dei fire rekneartane, så her må vi også nytte oss av potensreglar. Vi opphøg begge sidene av likninga med den omvende brøken\footnote{Hugs at $ 2=\frac{2}{1} $.} til 2:
...
\info{Merk}{
	Sjølv om likninga
	\[ x^a=b \]
	har $ a $ løysingar, er ikkje alle naudsynleg \textit{reelle}\footnote{Som vi tidlegare har vore inne på, er \textit{reelle} og \textit{imaginære} tal noko vi ikkje går nærare inn på i denne boka}. I denne boka nøyer vi oss med å finne alle rasjonale eller irrasjonale tal som løyser likninga. For eksempel har likning,
	\[ x^3=8 \]
