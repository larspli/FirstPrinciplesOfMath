...
One of the strengths of algebra is that we can express compact rules which are easily extended to apply for other cases. Let's, as an example, find another expression of
	\[ (a+b+c)d \]
\rref{gangpara} does not directly imply how to calculate between the expression in the parenthesis and $ d $, but there is no wrongdoing in defining $ a+b $ as $ k $:
\[ a+b=k \]
Then
\[ (a+b+c)d=(k+c)d \]
