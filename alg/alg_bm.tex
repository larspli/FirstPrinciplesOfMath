...
Verdien til tallene som er representert ved bokstaver vil ofte variere ut ifra en sammenheng, og da kaller vi disse bokstavtallene for \textit{variabler}\index{variabel}. Hvis bokstavtallene derimot har en bestemt verdi, kaller vi dem for \textit{konstanter}\index{konstant}.
...
Altså er
\[ (a+b+c)d=ad+bc+cd \]
\it Obs! Dette eksempelet er \textsl{ikke} ment for å vise hvordan man skal gå fram når man har uttrykk som ikke direkte er omfattet av \textsl{Regel} \ref{adkomalg}\,-\,\ref{gangmnegtrea}, men for å vise hvorfor det alltid er nok å skrive regler med færrest mulige ledd, faktorar og lignende. Oftest vil man bruke utvidelser av reglene uten engang å tenke over det, og i alle fall langt ifra så pertentlig som det vi gjorde her.
}
