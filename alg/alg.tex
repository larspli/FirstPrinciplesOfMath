...
\[ 1\cdot a=a \]
Det er også vanleg å utelate gongeteikn der parantesuttrykk er ein faktor:\[ 
3\cdot(a+b)=3(a+b) \]
}
\vsk 
...
Noko av styrken til algebra er at vi kan lage oss kompakte reglar som det er lett å utvide også til andre tilfelle. Lat oss som eit eksempel finne eit anna uttrykk for
	\[ (a+b+c)d \]
\rref{gangpara} fortel oss ikkje direkte korleis vi kan rekne mellom parantesuttrykket og $ d $, men det er ingenting som hindrar oss i å omdøpe $ a+b $ til $ k $:
\[ a+b=k \]
Da er
\[ (a+b+c)d=(k+c)d \]
