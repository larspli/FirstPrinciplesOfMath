...
Ein \textit{formel}\index{formel} er ei likning der ein variabel (som oftast) står aleine på éi side av likskapsteiknet. I \hrs{Areal}{seksjon} har vi allereie sett på formlar for arealet til rektangel og trekantar, men der brukte vi ord i staden for symbol. Her skal vi gjengi desse to formlane i ei meir algebraisk form, etterfulgt av andre klassiske formlar for areal og omkrins.\regv
...
\fork{\ref{arsirk} \arsirk}{
	I figuren under har vi delt opp ein sirkel i 4, 10 og 50 (like store) bitar, og lagt desse bitene etter kvarandre.
	\fig{tri19}
	\fig{tri19a}
	\fig{tri19b}
	I kvart tilfelle må dei små bogelengdene til saman utgjere heile bogelengda, altså omkrinsen, til sirkelen. Viss sirkelen har radius $ r $, betyr dette at summen av bogelengdene er $ 2\pi r $. Og når vi har like mange biter med bogen vendt opp som bitar med bogen vend ned, må lengda vere $ \pi r $ både oppe og nede. \vsk
	
	Men jo fleire bitar vi deler sirkelen inn i, jo meir liknar sammansettinga av bitane på eit rektangel (i figuren under har vi 100 bitar). Grunnlinja $ g $ til dette ''rektangelet'' vil vere tilnærma lik $ \pi r $, mens høgda vil vere tilnærma lik $ r $.
	\fig{tri19c}
...
\eks[1]{
	...
	Da $ \sqrt{25}=5 $, må lengda til $ c $ vere 5.
}
\newpage
...
\end{figure}
Lat oss kalle sidelengda til 12-kanten for $ s_{12} $ og sidelengda til 6-kanten for $ s_6 $. Vidare legg vi merke til at punkta $ A $ og $ C $ ligg på sirkelbogen og at både $ \triangle ABC $ og $ \triangle BSC $ er rettvinkla trekantar (forklar for deg sjølv kvifor!). Vi har at
\alg{
	SC &= 1 \\
	BC &= \frac{s_6}{2} \\
	SB &= \sqrt{SC^2-BC^2} \\
...
Lat oss derfor tenke oss mangekantar med så mange sider at vi godtek deira omkrins som lik omkrinsane til sirklane. Om vi da skriv omkrinsen til den største og den minste sirkelen som høvesvis $ O $ og $ o $, får vi at
\[ \frac{O}{R}=\frac{o}{r} \]
