...
\fork{\ref{arsirk} \arsirk}{
	...
	\fig{tri19a}
	\fig{tri19b}
	In each case, the arcs makes up the circumference of the circle. If the circle has radius $ r $, the sum of the arcs equals $ 2\pi r $. And when there are equally many sectors turned upwards as downwards, the total length of the arcs equals $ \pi r $ on both the bottom and the top. \vsk
...
\reg[Formlike trekantar \index{triangle!similar}]{Similar triangles constitute three pairs of equal angles.
\fig{geo8}
...
\fig{geo9c}
Clearly, the circumference of the circle is smaller then the perimeter of the square, therefore
\alg{
	O_1&<2\cdot4  \\
	&< 8
}
...
\[ \frac{O}{R}=\frac{o}{r} \]
Since the circles are randomly chosen, we conclude that \textit{all circles have the same ratio of the circumference to the radius}. An equivalent statement is that \textit{all cicles have the same ratio of the circumference to the diameter}. \vsk
