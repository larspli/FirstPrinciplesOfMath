...
\fig{kant1}
The segments of a polygon are called \textit{edges}\index{edge} or \textit{sides}\index{side!of polygon}. The respective intersection points of the segments are the \textit{vertices}\index{polygon!vertices of} of the polygon. That is, the triangle below have vertices $ A $, $ B $ and $ C $ and sides (edges) $ AB $, $ BC $ and $ AC $.
\fig{kant2}
\info{Noitce}{
