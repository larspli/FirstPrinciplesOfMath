...
\begin{itemize}
\item Kva tid ein snakkar om eit linjestykke og kva tid ein snakkar om ei lengde vil komme tydeleg fram av samanhengen omgrepet blir brukt i.
...
To linjer som ikkje er parallelle, vil før eller sidan krysse kvarandre. Gapet to linjer dannar seg i mellom kallast ein \textit{vinkel}\index{vinkel}. Vinklar teiknar vi som små sirkelboger:
\fig{vink1}
...
\info{Kva vinkel?}{
	...
	\fig{vink2a}
	Så lenge det berre er to linjestykker/linjer som dannar ein vinkel, er det også vanleg å bruke berre éin bokstav for å vise til vinkelen:
	\fig{vink2b}
}\vsk
\label{vinkelend}
\newpage
