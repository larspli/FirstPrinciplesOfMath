...
\spr{
	Eit gongestykke består av to eller fleire \textit{faktorar}\index{faktor} og eitt \textit{produkt}\index{produkt}. I gongestykket
	\[ {4\cdot 3=12} \]
...
Lat oss no bruke ein figur for å sjå for oss gongestykket $ 2\cdot3 $:
\fig{2t3}
