...
\spr{
	A calculation involving multiplication includes severeal \textit{factors}\index{factor} and one \textit{product}\index{produkt}. In the calculation
	\[ {4\cdot 3=12} \]
	both $ 4 $ and $ 3 $ are factors, while $ 12 $ is the product. \vsk
	
	Common ways of saying $ 4\cdot3 $ are
	\begin{itemize}
		\item ''4 times 3''  \\
...
\info{Notice}{
The fact that multiplication with positive integers can be expressed as repeated addition does not exclude other expressions. It's nothing wrong with writing $ {2\cdot 3=1+5} $.
}
