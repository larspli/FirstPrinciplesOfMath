...
Å subtrahere eit negativt tal er det same som å addere talet med same talverdi.
}
\eks[1]{ \vs
\[ 11-(-9)=11+9=20 \]
}
...
\reg[Multiplikasjon med positive og negative tal I \label{gongneg}]{ \vs
\begin{itemize}
...
Det blir tungvint å rekne gonging som gjentatt addisjon/subtraksjon kvar gong vi har eit negativt tal involvert, men som ein direkte konsekvens at \rref{gongneg} kan vi lage oss følgande to reglar:\regv
...
\subsection*{Divisjon}
Definisjon av divisjon (sjå \hrs{Divisjon}{seksjon}), kombinert med det vi veit om multiplikasjon med negative tal, gir oss no dette:\regv
