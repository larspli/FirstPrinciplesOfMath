...
Lengden til et negativt tall er verdien til det positive tallet med same siffer.
} 
\eks[1]{ \vs \vs
\[ |27|=27 \]
}
...
Å addere et negativt tall er det samme som å subtrahere tallet med same tallverdi.
}
\eks[1]{ \vs
	\[ 4+(-3)=4-3=1 \]
}
...
Å subtrahere et negativt tall er det sanme som å addere tallet med samme tallverdi.
}
\eks[1]{ \vs
\[ 11-(-9)=11+9=20 \]
}
...
\reg[Multiplikasjon med positive og negative tall I \label{gongneg}]{ \vs
\begin{itemize}
...
Det blir tungvint å regne ganging som gjentatt addisjon/subtraksjon kvar gang vi har et negativt tall involvert, men som en direkte konsekvens at \rref{gongneg} kan vi lage oss følgende to regler:\regv
...
\subsection*{Divisjon}
Definisjon av divisjon (se \hrs{Divisjon}{seksjon}), kombinert med det vi vet om multiplikasjon med negative tall, gir oss nå dette:\regv
