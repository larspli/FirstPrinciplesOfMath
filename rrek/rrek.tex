...
\subsection*{Gonging med parantes}
...
\info{Obs!}{
Vi introduserte parantesar som ein indikator på kva som skulle reknast ut først, men \rref{gangpar} gir ei alternativ og likeverdig tyding av parantesar. Regelen kjem spesielt til nytte i algebrarekning (sjå \hrs{Del2}{Del}).
}
\newpage
...
Plasseringa av parantesar mellom ledd har inga påverknad på summen.
}
\eks[]{ \vsb \vs
\alg{
(2+3)+4&=8 \vn
...
Plasseringa av parantesar mellom faktorar har inga påverknad på produktet.
}
\eks[]{ \vsb \vs
\alg{
...
Vi har sett at parantesane hjelp oss med å seie noko om \textsl{prioriteringa} av rekneartane, men det at subtraksjon og divisjon er ikkje-assosiative fører til at vi også må ha ein regel for kva \textsl{retning} vi skal rekne i. \regv
