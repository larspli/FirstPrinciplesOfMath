...
When an expression enclosed by a parenthesis is a factor, we can multiply the other factors with each term inside the parentheses.	 
%\fig{gang1}
}
\eks[1]{
\vs
