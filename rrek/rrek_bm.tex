...
\eks[2]{
	...
	\sv \vs \vs
	\algv{
		&& 18:(7-5)&=18:2-3 &&\text{Parantes} \\
		&&&=9-3 &&\text{Deling} \\
		&&&=6 &&\text{Addisjon og subtraksjon}
	}
}
\subsection*{Ganging med parantes}
...
\info{Obs!}{
Vi introduserte paranteser som ein indikator på hva som skulle regnes ut først, men \rref{gangpar} gir en alternativ og likeverdig betydning av paranteser. Regelen kommer spesielt til nytte i algebraregning (sjå \hrs{Del2}{Del}).
}
\newpage
...
Plasseringen av paranteser mellom ledd har ingen påvirkning på summen.
}
\eks[]{ \vsb \vs
\alg{
(2+3)+4&=8 \vn
...
Plasseringen av paranteser mellom faktorer har ingen påvirkning på produktet.
}
\eks[]{ \vsb \vs
\alg{
...
Vi har sett at parantesene hjelper oss med å si noeo om \textsl{prioriteringen} av regneartene, men det at subtraksjon og divisjon er ikke-assosiative fører til at vi også må ha en regel for hvilken \textsl{retning} vi skal regne i. \regv
