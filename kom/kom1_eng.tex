...
\newpage
In \hrs{Del1}{Part} we have tried to present the \textsl{motivation} behind the axioms, because (obviously) they are not randomly selected. The train of thoughts that leads us to the them is the following:
\begin{enumerate}
