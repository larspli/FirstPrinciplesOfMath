...
Positive heiltal blir også kalla \textit{naturlege tal}\index{naturlege tal}.
}
\info{Kva med 0?}{
Nokre forfattarar inkluderer også 0 i omgrepet positive heiltal/naturlege tal. I nokre samanhengar vil dette lønne seg, i andre ikkje.
}
...
\st{Eit punkt skriv vi som to tal inni ein parantes. Dei to tala blir kalla \textit{førstekoordinaten} og \textit{andrekoordinaten}.
	\begin{itemize}
